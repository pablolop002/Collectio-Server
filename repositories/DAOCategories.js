  ...
  addCategory(category, callback) {
    this.pool.getConnection(function (err, connection) {
      if (err) {
        ...
        connection.query(
          "INSERT INTO Categories(Spanish, English, Catalan, Basque) VALUES (?, ?, ?, ?)",
          [
            category.Spanish,
            category.English,
            category.Catalan,
  ...
  updateCategory(category, callback) {
    this.pool.getConnection(function (err, connection) {
      if (err) {
        ...
        connection.query(
          "UPDATE Categories SET Spanish = ?, English = ?, Catalan = ?, Basque = ? WHERE Id = ?",
          [
            category.Spanish,
            category.English,
            category.Catalan,
  ...
  addSubcategory(subcategory, callback) {
    this.pool.getConnection(function (err, connection) {
      if (err) {
        ...
        connection.query(
          "INSERT INTO Subcategories(CategoryId, Spanish, English, Catalan, Basque) VALUES (?, ?, ?, ?, ?)",
          [
  ...
  updateSubcategory(subcategory, callback) {
    this.pool.getConnection(function (err, connection) {
      if (err) {
        ...
        connection.query(
          "UPDATE Subcategories SET Spanish = ?, English = ?, Catalan = ?, Basque = ? WHERE Id = ?",
          [
            subcategory.Spanish,
            subcategory.English,
            subcategory.Catalan,
