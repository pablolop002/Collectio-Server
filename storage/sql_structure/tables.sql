...
VALUES (1, NULL, 'Antigüedades', 'Antiques', '', ''),
       ...
       (9, NULL, 'Comunicación y sonido', 'Communication & Sound', '', ''),
       (10, NULL, 'Costura y manualidades', 'Sewing & Handicraft', '', ''),
       (11, NULL, 'Deportes y eventos', 'Sports & Events', '', ''),
       (12, NULL, 'Informática y electrónica', 'Computer & Electronics', '', ''),
       (13, NULL, 'Interiores y decoración', 'Interiors & Decorations', '', ''),
       (14, NULL, 'Joyería', 'Jewellery', '', ''),
       ...
       (20, NULL, 'Otros', 'Other', '', ''),
       (21, NULL, 'Papelería', 'Stationery', '', ''),
       (22, NULL, 'Relojes', 'Watches', '', ''),
       (23, NULL, 'Sellos', 'Stamps', '', ''),
       (24, NULL, 'Textil', 'Textile', '', '');
